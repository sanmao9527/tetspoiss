function editDetail(projectid,xianId) {
    window.location.href = "../bus/projectcompany.html?projectId=" + projectid+","+xianId;
}
$(function () {
    (function ($) {
        ...
        colModel: [
            ...
            {label: '项目状态', name: 'stateName',  index: 'stateName', width: 100},
            {
                ...
                formatter: function (cellvalue, options, rowObject) {
                    ...
                    detail += "&nbsp;&nbsp;<button  onclick='editDetail(\"" + rowObject.projectId +","+rowObject.deptXianId+ "\")''>绑定经济组织</button>";
                    return detail;
                }
            }
        ],
