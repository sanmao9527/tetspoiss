...
$(function () {
    ...
    var par = 'projectNew/list';
    if (projectId != null) {
        par = 'projectNew/list?projectId=' + projectId;
    }
    $("#jqGrid").jqGrid({
        url: baseURL + par,
        datatype: "json",
...
var vm = new Vue({
    ...
    methods: {
        ...
        saveOrUpdate: function (event) {
            ...
            var url = vm.vo.id == null ? "projectNew/save" : "projectNew/update";
...
//            vm.vo.deptXianName = vm.xians.find(item => item.deptId === vm.xian)['name'];
        ...
        getInfo: function (id) {
            $.get(baseURL + "projectNew/info/" + id, function (r) {
                vm.vo = r.vo;
